...
class CitySimulation {
  constructor(id, secondsPerHour = 10) {
    ...
    this.simulationHour = this.currentTime.getHours(); // Start at current hour, or set to 0/8 if you prefer
    this.hourCounter = 0; // Total elapsed hours, not output
    this.Fnter = 8;
  ...
  start() {
    ...
    this.interval = setInterval(initialgen, this.intervalMs);
  }
